...
def get_args():
    ...
    parser.add_argument("--src", type=str, default="./results/results.csv", help="Path to the results file")
    parser.add_argument("--dst", type=str, default="./figures/", help="Path to the results file")
